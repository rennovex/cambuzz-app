...
final List<Post> feed = [
  Post(
    ...
    profile_name: 'The Hangout',
    user_name: 'shaquille.oatmeal',
    time: '',
    post_type: PostType.ImagePost,
  ),
  Post(
    post_img:
    ...
    profile_name: 'The Java Room',
    user_name: 'hanging_gnomies',
    time: '',
    post_type: PostType.ImagePost,
  ),
  Post(
    ...
    profile_name: 'Communion',
    user_name: 'hoosier-daddy',
    time: '',
    post_type: PostType.ImagePost,
  ),
  Post(
